...
void SkyboxCommon::CreateGraphicsPipelineState()
{
	...
	//ShaderをCompileする
	Microsoft::WRL::ComPtr<IDxcBlob> vertexShaderBlob = dxCommon_->CompileShader(L"Resource/shaders/Skybox.VS.hlsl",
		L"vs_6_0");
	assert(vertexShaderBlob != nullptr);

	Microsoft::WRL::ComPtr<IDxcBlob> pixelShaderBlob = dxCommon_->CompileShader(L"Resource/shaders/Skybox.PS.hlsl",
		L"ps_6_0");
...
void SkyboxCommon::CommonDrawSettings(ID3D12GraphicsCommandList* commandList)
{
	//ルートシグネチャをセットするコマンド
